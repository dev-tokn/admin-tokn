...
export const columns: ColumnDef<Tippee>[] = [
  {
    id: 'actions',
    enableHiding: false,
    header: () => {
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem onClick={() => navigator.clipboard.writeText(tippee.id)}>
              Copy tippee ID
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem>View details</DropdownMenuItem>
            <DropdownMenuItem>Edit tippee</DropdownMenuItem>
            <DropdownMenuItem className="text-red-600">Delete tippee</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      );
    },
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex text-sm flex-col">
          <div className="font-medium">{tippee.firstName} {tippee.lastName}</div>
          <div className="text-muted-foreground">@{tippee.userName}</div>
        </div>
      );
    },
  },
